        ...
        <tbody>
          {data.map((filme) => (
            <tr key={filme.id}>
              ...
              <td>{filme.titulo}</td>
              <td>
                <img src={filme.imagem} width="70" height="100" alt="" />
              </td>
              <td>{filme.sinopse}</td>
              <td>{formatDate(filme.dataLancamento)}</td>
              <td>{filme.classificacao}</td>
              <td>{filme.elenco}</td>
              <td>{filme.genero}</td>
              <td>
                <div className="button-container">
                  <button className="btn btn-primary" onClick={() => selecionarFilme(filme, "Editar")}>
                    Editar
                  </button>{" "}
                  <button className="btn btn-danger" onClick={() => selecionarFilme(filme, "Eliminar")}>
                    Eliminar
                  </button>
                </div>
              </td>
